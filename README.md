...
- Shows famous Tamil Nadu temples based on selected deity
- Shows famous Tamil Nadu places for selected gods, planets, and gurus
- Temple names open directly in Google Maps search
- Murugan selection includes expandable Aru Padai Veedu (6 abodes)
